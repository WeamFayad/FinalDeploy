...
function Terms() {
  return (
    <div className="terms-body">
      ...
      <p>Welcome to paws.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Paws's Website, located at https://www.paws.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use paws.com if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing paws.com, you agreed to use
        cookies in agreement with the Paws's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Paws and/or its licensors own the intellectual
        property rights for all material on paws.com. All intellectual property
        rights are reserved. You may access this from paws.com for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from paws.com</li>
        <li>Sell, rent or sub-license material from paws.com</li>
        <li>Reproduce, duplicate or copy material from paws.com</li>
        <li>Redistribute content from paws.com</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Paws
        ...
        of Paws,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Paws shall not be liable for the Comments
      ...
      <p>
        Paws reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Paws a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Paws; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Paws. Please include your name, your organization name,
      ...
      <p>
        No use of Paws's logo or other artwork will be allowed for linking
